...
(function () {
	...
	function Listener() {
		...
		this.object.on('exit', this.emit.bind(this, 'close'));

		// when the remote request a method, the methods should exists in .handlers
		this.handlers.close = this.emit.bind(this, 'close');
	...
	Listener.prototype.close = function () {
		...
		var connect = this.connections[0];
		connect.request('close', [], connect.emit.bind(connect, 'close'));
	};
